...
const LoginPage = () => {
    ...
    return (
        <form className="auth-form" onSubmit={onSubmit} noValidate>
            ...
            <div className="form-field field-with-link">
                <label htmlFor="password">Password</label>
                <Link to="/auth/forgot" className="inline-link">Forgot password?</Link>
            ...
            <button type="button" className="ghost-btn" onClick={startGoogleOAuth}>
            ...
            <p className="footnote">
                New to EduPredict? <Link to="/auth/signup">Create an account</Link>
            </p>
        </form>
    )
}
