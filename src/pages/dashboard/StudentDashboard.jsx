    ...
    useEffect(() => {
        const fetchDashboardData = async () => {
            try {
                ...
                const summaryRes = await fetch(`${import.meta.env.VITE_API_BASE_URL || "${import.meta.env.VITE_API_BASE_URL || "${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/api"}"}/dashboard/my-summary`, { credentials: 'include' });
                if (summaryRes.ok) {
